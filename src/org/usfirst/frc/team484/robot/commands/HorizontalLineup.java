...
public class HorizontalLineup extends Command {
    ...
    public HorizontalLineup() {
    	...
    	pid = new PIDController(RobotSettings.rotateAngle2kP, RobotSettings.rotateAngle2kI, RobotSettings.rotateAngle2kD, new PIDSource() {
    ...
    protected void initialize() {
    	...
    	pid.setSetpoint(-Robot.visionCalc.lastHorizontalAngle);
    	pid.reset();
    	pid.enable();
    }
